...
Lives in `thinkpad-t16-gen4-ubuntu-suspend-chronology.md` — session-dated
narrative in which later entries may refute earlier ones. It is provenance
for the conclusions here, not a source of facts to act on; this doc alone
